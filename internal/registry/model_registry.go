...
func (r *ModelRegistry) convertModelToMap(model *ModelInfo, handlerType string) map[string]any {
	...
	case "claude", "antigravity":
		...
		// Upstream: conform Claude model listing to Anthropic API schema with
		// max_input_tokens / max_tokens (defaulted when unset).
		...
		// Fork: Claude-compatible clients use this registry payload to determine
		// whether to surface extended thinking controls.
		if model.Thinking != nil {
