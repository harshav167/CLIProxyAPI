...
type StreamingConfig struct {
	...
	// <= 0 disables generic stream keep-alives. Claude /v1/messages bootstrap uses a
	// 15-second first-byte heartbeat when unset to avoid intermediary origin timeouts.
