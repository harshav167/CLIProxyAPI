...
// ClaudeOAuthToolRenameMap maps OpenCode-style (lowercase) tool names to
// Claude Code-style (TitleCase) names. Reserved for OAuth tool-name remapping
// at the executor layer; this map is not applied automatically here.
